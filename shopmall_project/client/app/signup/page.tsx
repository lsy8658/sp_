...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const id = await signUp({ email, password, nickname });
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 dark:bg-neutral-950">
      ...
      >
        ...
        <button
          type="submit"
          className="w-full rounded-lg bg-neutral-900 py-2.5 text-sm font-medium text-white transition hover:bg-neutral-800 dark:bg-white dark:text-neutral-900"
        >
          가입하기
        </button>
